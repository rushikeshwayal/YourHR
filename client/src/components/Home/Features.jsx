function Feature() {
  return (
    <div class=" flex flex-wrap p-4 justify-center w-full items-center">
    ...
    <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        <div class="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            ...
            <div>
                ...
                <p class="text-base font-medium text-body-color">Apply to different companys as per your skill set ang get job free</p>
            </div>
        </div>
    </div>
    ...
    <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        <div class="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            ...
            <div>
                ...
                <p class="text-base font-medium text-body-color">Find email of Industry expert and get guidances from them</p>
            </div>
        </div>
    </div>
    ...
    <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        <div class="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            ...
            <div>
                <h3 class="mb-4 text-xl font-bold text-black sm:text-2xl lg:text-xl xl:text-2xl"> Easy To Apply 
                </h3>
                <p class="text-base font-medium text-body-color">Apply for job or internship in easy steps, get   bunch of opportunities to grow your career</p>
            </div>
        </div>
    </div>
    ...
    <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        <div class="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            ...
            <div>
                ...
                <p class="text-base font-medium text-body-color">Connect on Social media for regular updates.</p>
            </div>
        </div>
    </div>
    ...
    <div class="w-full px-4 md:w-1/2 lg:w-1/3">
        <div class="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            ...
            <div>
                <h3 class="mb-4 text-xl font-bold text-black sm:text-2xl lg:text-xl xl:text-2xl">Attach Your Resume 
                </h3>
                <p class="text-base font-medium text-body-color">Apply for jobs or internship with you Resume</p>
            </div>
        </div>
    </div>
</div>
